...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertPet() {
        ...
        values.put(PetEntry.COLUMN_PET_CONTACT, "9124046288");
        values.put(PetEntry.COLUMN_PET_GENDER, "Male");
        values.put(PetEntry.COLUMN_PET_EXTRAS, "Nothing");
    ...
    private void deleteAllPets() {
        ...
        Toast.makeText(getApplicationContext(),rowsDeleted+" participants deleted",Toast.LENGTH_LONG).show();
    ...
    private void showDeleteConfirmationDialog() {
        ...
        builder.setMessage("Are you sure of deleting all participants?");
